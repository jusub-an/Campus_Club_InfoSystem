...
public class ClubController {
	...
	public String register(ClubDTO club, RedirectAttributes rttr, HttpSession session) {
	...
	// 동아리 수정 
	@PostMapping("/modify") 
	public String modify(HttpSession session, ClubDTO club, RedirectAttributes rttr) {
